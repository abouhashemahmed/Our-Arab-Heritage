        ...
        (style, item) =>
          item && (
            <animated.div
              ...
              className="absolute mt-1 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-lg focus:outline-none"
              role="menu"
            ...
            >
              <div ref={menuRef} className="py-1">
                ...
                <button
                  ...
                  role="menuitem"
                  tabIndex={isOpen ? 0 : -1}
                  className="w-full px-4 py-2 text-left text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 focus:bg-red-50 dark:focus:bg-red-900/30 focus:outline-none"
                >
                  Delete
                </button>
              </div>
